...
resource "aws_security_group_rule" "allow_dnsmasq_tcp_inbound" {
  count       = "${length(var.allowed_inbound_cidr_blocks) >= 1 ? 1 : 0}"
  type        = "ingress"
...
resource "aws_security_group_rule" "allow_dnsmasq_udp_inbound" {
  count       = "${length(var.allowed_inbound_cidr_blocks) >= 1 ? 1 : 0}"
  type        = "ingress"
  from_port   = "${var.dnsmasq_port}"
  to_port     = "${var.dnsmasq_port}"
...
resource "aws_security_group_rule" "allow_dnsmasq_tcp_inbound_from_security_group_ids" {
  count                    = "${var.allowed_inbound_security_group_count}"
  type                     = "ingress"
  from_port                = "${var.dnsmasq_port}"
  to_port                  = "${var.dnsmasq_port}"
...
resource "aws_security_group_rule" "allow_dnsmasq_udp_inbound_from_security_group_ids" {
  count                    = "${var.allowed_inbound_security_group_count}"
  type                     = "ingress"
  from_port                = "${var.dnsmasq_port}"
  to_port                  = "${var.dnsmasq_port}"
